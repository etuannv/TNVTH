...
(function() {
  ...
  LightboxOptions = (function() {
    ...
    function LightboxOptions() {
      this.fileLoadingImage = '/Content/plugins/lightbox-print/images/loading.gif';
      this.fileCloseImage = '/Content/plugins/lightbox-print/images/close.png';
      this.filePrintImage = '/Content/plugins/lightbox-print/images/print.png';
      this.resizeDuration = 500;
      this.fadeDuration = 200;
      this.labelImage = "Ảnh số";
      this.labelOf = "trong";
    }
	...
	Lightbox.prototype.print = function() {
		...
		iframe.load(function(e){
			...
			//{
				...
				div.setAttribute('style', 'color:#444;')
				body.appendChild(div);
			//}
